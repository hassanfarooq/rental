    ...
    <div class="row">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              ...
              <div class="car-img">
                <img src="<?php echo base_url('assets/site/img/home-slider/slide1.png'); ?>" class="img-responsive" alt="car1">
              </div>
            </div>
            <div class="item">
              ...
              <div class="car-img">
                <img src="<?php echo base_url('assets/site/img/home-slider/slide2.png'); ?>" class="img-responsive" alt="car1">
              </div>
            </div>
			<div class="item">
              <h1 class="title">Get 15% off your rental
                <span class="subtitle">Plan your trip now</span></h1>
              <div class="car-img">
                <img src="<?php echo base_url('assets/site/img/home-slider/slide3.png'); ?>" class="img-responsive" alt="car1">
              </div>
            </div>
			<div class="item">
              <h1 class="title">Get 15% off your rental
                <span class="subtitle">Plan your trip now</span></h1>
              <div class="car-img">
                <img src="<?php echo base_url('assets/site/img/home-slider/slide4.png'); ?>" class="img-responsive" alt="car1">
              </div>
            </div>
          </div>
      ...
      <div class="col-md-5 col-xs-12 pull-left">
        <div class="reservation-form-shadow">
          ...
          <form action="<?php echo site_url('Search/searchByCriteria'); ?>" method="get" id="car-select-form">
			...
			<div class="form-group">
              <select class="form-control" name="province-select" id="select-province">
                <option value="0">Select your provinces</option>
			...
			<div class="form-group">
				<div class="car_select"></div>
              <select class="form-control" name="city-select" id="select-city">
                <option value="0">Select your city</option>
              </select>
            </div>
            <!-- Car select start -->
            <div class="form-group">
              <select class="form-control" name="manufacturer-select" id="select-manufacturer">
			...
			<div class="form-group">
              <select class="form-control" name="car-select" id="select-car">
...
<!--<section id="locations">
  ...
  <div class="map wow bounceInUp" data-wow-offset="100"></div>
</section>-->
<!-- Locations end -->
