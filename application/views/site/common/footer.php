  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p class="copyright">©2016 E - CAR RENTAL, All Rights Reserved</p>
      </div>
    </div>
  </div>
</footer>
          ...
          <div class="checkout-vehicle-info">
            ...
            <div class="vehicle-info">
              ...
              <div class="vehicle-image">
                <img class="img-responsive" id="selected-vehicle-image" src="http://localhost/projects/final-project/assets/site/img/vehicle1.jpg" alt="Vehicle">
              </div>
            </div>
...
<script src="<?php echo base_url('assets/site/js/style-switcher.js'); ?>"></script>
...
<script src="<?php echo base_url('assets/site/js/jquery.autocomplete.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/site/js/jquery.placeholder.js'); ?>"></script>
<script src="<?php echo base_url('assets/site/js/locations-autocomplete.js'); ?>"></script>
<script src="<?php echo base_url('assets/site/js/bootstrap-datepicker.js'); ?>"></script>
<!--<script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>-->
<script src="<?php echo base_url('assets/site/js/gmap3.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/site/js/mootools-1.2-core.js'); ?>"></script>
...
<script src="<?php echo base_url('assets/site/js/main2.js'); ?>"></script>
